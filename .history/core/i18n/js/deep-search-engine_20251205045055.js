...
(function () {
  ...
  const els = {
    ...
    // ندعم data-modal-copy و data-modal-copy-link معاً
    modalCopyBtn: document.querySelector("[data-modal-copy], [data-modal-copy-link]"),
  ...
  // =========================
   // =========================
  // 3) تطبيق الفلاتر (نسخة تشخيصية)
  // =========================
  function applyFiltersAndRender() {
    // مؤقتاً: تجاهل جميع الفلاتر وعرِض كل الخدمات كما هي
  ...
  function openServiceModal(svc) {
    ...
    // لو ما فيه مودال في الصفحة: افتح الرابط مباشرة
    if (!els.modal) {
