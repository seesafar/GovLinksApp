...
// ===============================
// نظام الفلاتر الحصري (Exclusive Filters)
// ===============================
...
filterChips.forEach((chip) => {
  chip.addEventListener("click", () => {
    ...
    // تنفيذ عملية البحث بعد تغيير الفلتر
    if (typeof runSearch === "function") {
      ...
      console.warn("[UDSAL] No search update function found after filter change.");
    }
  });
});
/* 🌊 Ripple داخل أزرار الفلاتر */
.filter-chip .ripple {
  position: absolute;
  border-radius: 999px;
  pointer-events: none;
  ...
  animation: udsalRipple 0.55s ease-out;
}

@keyframes udsalRipple {
  0% {
    transform: scale(0);
    opacity: 0.75;
  }
